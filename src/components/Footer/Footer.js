        ...
        return (
            <>
                <Container fluid={true} className="footer text-center">
                    <Row>
                        ...
                        <Col lg={3} md={6} sm={6} className="p-5 text-justify">
                            ...
                            <p className="serviceDes"> <FontAwesomeIcon className="" icon={faMapMarkedAlt} /> Fouzdarhat Cadet College, Salimpur Union, Chattogram</p>
                            <p className="serviceDes">  <FontAwesomeIcon className="" icon={faEnvelope} /> sayemuddin471@gmail.com</p>
                            <p className="serviceDes">  <FontAwesomeIcon className="" icon={faPhone} /> (+880) 1316522214</p>
                ...
                <Container fluid={true} className="text-center copyRightSection">
                    ...
                    <a className="copyRightLink" href="#">Md Sayem Uddin &copy; 2020-2021</a>
